  ...
  return (
    <section className="p-10  ">
      <div className="flex justify-between items-center">
        <div className="w-3/4">
          <h2 className="text=soft-brown text-sm font-semibold uppercase mb-2  text-white">A bit of My Story</h2>
          <h3 className="text-3xl font-bold mb-4  text-white">How it all began</h3>
